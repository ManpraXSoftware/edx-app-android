...
public interface IMyCoursesLocators {
	...
	// Login Id's
	String tbEmailId = "org.tta.mobile:id/email_et";
	String tbPasswordId = "org.tta.mobile:id/password_et";
	String btnSigninId = "org.tta.mobile:id/login_button_layout";
	...
	// Find A Course id's
	String btnFindACourseId = "org.tta.mobile:id/course_btn";
	String btnDontSeeCoursesId = "org.tta.mobile:id/course_not_listed_tv";
	String btnCloseId = "org.tta.mobile:id/positiveButton";
	...
	String btnSectionSubsectionDownloadId = "org.tta.mobile:id/bulk_download_layout";
	...
	String hlnkViewOnWebId = "org.tta.mobile:id/open_in_browser_btn";
	String btnVideoId = "org.tta.mobile:id/video_row_layout";
	String btnVideoDownloadId = "org.tta.mobile:id/video_start_download";

	// Download Screen, Download Message Id's
	String btnDownloadScreenId = "org.tta.mobile:id/down_arrow";
	String btnDownloadScreenCancelId = "org.tta.mobile:id/close_btn";
	String dlgLargeDownloadsId = "org.tta.mobile:id/dialog_layout";
	String lbVideoName = "org.tta.mobile:id/video_title";
	String lbVideoSize = "org.tta.mobile:id/video_size";
	String lbVideoLength = "org.tta.mobile:id/video_playing_time";
	String btnViewId = "org.tta.mobile:id/button_view";
	String lstDownloadVideosId = "org.tta.mobile:id/downloads_row_layout";
	String msgDownloadId = "org.tta.mobile:id/flying_message";
	String downloadProgressWheel = "org.tta.mobile:id/progress_wheel";

	// Video player Id's
	String vpVideoPlayerId = "org.tta.mobile:id/preview";
	String lbVideoNameVideoPlayerId = "org.tta.mobile:id/video_title";
	...
	String popupLanguages = "org.tta.mobile:id/row_cc_lang";
	String txtSubtitlesId = "org.tta.mobile:id/txtSubtitles_tv";
	String popupLanguagesCancel = "org.tta.mobile:id/tv_cc_cancel";

	// No CourseWare available id
	String lbCourseWareId = "org.tta.mobile:id/no_chapter_tv";
	...
	String txtMySettingsId="org.tta.mobile:id/drawer_option_my_settings";
...
+"Wi-Fi is not available. Data charges may apply.";
	...
	String btnSettingsId = "org.tta.mobile:id/wifi_setting";
	
	//Find Courses
	String txtFindCourseName="Find Courses";
	String findACoursewebView="org.tta.mobile:id/webview";
