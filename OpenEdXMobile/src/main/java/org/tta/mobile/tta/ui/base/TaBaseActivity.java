package org.tta.mobile.tta.ui.base;
...
import org.tta.mobile.tta.widget.loading.ILoading;
import org.tta.mobile.tta.widget.loading.ProgressDialogLoading;
import org.tta.mobile.util.PermissionsUtil;
import org.tta.mobile.view.dialog.AlertDialogFragment;
...
public class TaBaseActivity extends RxAppCompatActivity implements RoboContext, ILoading {
    ...
    public void showIndefiniteSnack(String msg){
        showIndefiniteSnack(msg, getString(R.string.ok), null);
    }
