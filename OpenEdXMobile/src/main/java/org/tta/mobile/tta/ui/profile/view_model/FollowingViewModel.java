...
public class FollowingViewModel extends BaseViewModel {
    ...
    public FollowingViewModel(Context context, TaBaseFragment fragment) {
    ...
    private void getUsers() {
        ...
        mDataManager.getFollowersOrFollowing(false, take, skip, new OnResponseCallback<List<SuggestedUser>>() {
            @Override
