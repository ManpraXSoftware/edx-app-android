package org.tta.mobile.tta;

public class Constants {

    //Database
    public static final String TA_DATABASE = "ta-database";
    ...
    public static final String KEY_OTP_SOURCE = "otp_source";
    public static final String KEY_HONOR_CODE = "honor_code";
    ...
    public static final long INTERVAL_SYNC_ANALYTICS_JOB = 5*60*1000;
