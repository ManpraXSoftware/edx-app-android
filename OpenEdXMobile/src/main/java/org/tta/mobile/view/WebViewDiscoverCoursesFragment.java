...
import org.tta.mobile.databinding.FragmentWebviewCourseDiscoveryBinding;
import org.tta.mobile.event.MainDashboardRefreshEvent;
...
import org.tta.mobile.model.SubjectModel;
import org.tta.mobile.module.analytics.Analytics;
import org.tta.mobile.util.FileUtil;
import org.tta.mobile.util.ViewAnimationUtil;
import org.tta.mobile.view.adapters.PopularSubjectsAdapter;
...
import static org.tta.mobile.util.UrlUtil.QUERY_PARAM_SEARCH;
import static org.tta.mobile.util.UrlUtil.QUERY_PARAM_SUBJECT;
import static org.tta.mobile.util.UrlUtil.buildUrlWithQueryParams;
