...
@Singleton
public class Config {
 // Stage-   {"API_HOST_URL":"https://staging-lms.visionempowertrust.org/","ENVIRONMENT_DISPLAY_NAME":"Subodha","PLATFORM_NAME":"Subodha Platform","PLATFORM_DESTINATION_NAME":"staging-lms.visionempowertrust.org","FEEDBACK_EMAIL_ADDRESS":"support@example.com","DISCOVERY_BASE_URL":"https://staging-courses.visionempowertrust.org/","FIREBASE":{"ENABLED":true,"ANALYTICS_ENABLED":true,"ANALYTICS_SOURCE":"firebase"},"OAUTH_CLIENT_ID":"hfJw0EySorLOWdkMUx76HBq8DcEzkfwhdNtfz8wb","CERTIFICATES_ENABLED":true}
 // Prod-    {"API_HOST_URL":"https://subodha-lms.visionempowertrust.org/","ENVIRONMENT_DISPLAY_NAME":"Subodha","PLATFORM_NAME":"Subodha Platform","PLATFORM_DESTINATION_NAME":"subodha-lms.visionempowertrust.org","FEEDBACK_EMAIL_ADDRESS":"support@example.com","DISCOVERY_BASE_URL":"https://subodha-courses.visionempowertrust.org/","FIREBASE":{"ENABLED":true,"ANALYTICS_ENABLED":true,"ANALYTICS_SOURCE":"firebase"},"OAUTH_CLIENT_ID":"hfJw0EySorLOWdkMUx76HBq8DcEzkfwhdNtfz8wb","CERTIFICATES_ENABLED":true}
 // CMD for config.json changes : bash gradlew -p OpenEdXMobile applyConfigStageDebug --no-configuration-cache
