...
import org.humana.mobile.model.api.RegisterResponseFieldError;
...
import org.humana.mobile.module.registration.model.RegistrationFieldType;
import org.humana.mobile.module.registration.model.RegistrationFormField;
import org.humana.mobile.module.registration.view.IRegistrationFieldView;
import org.humana.mobile.module.registration.view.RegistrationEditTextView;
import org.humana.mobile.module.registration.view.RegistrationSelectView;
import org.humana.mobile.social.SocialFactory;
import org.humana.mobile.social.SocialLoginDelegate;
import org.humana.mobile.task.RegisterTask;
...
import org.humana.mobile.view.custom.DividerWithTextView;
...
public class RegisterActivity extends BaseFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agreementMessageView.setText(org.humana.mobile.util.TextUtils.generateLicenseText(getResources(), R.string.by_creating_account));
...
//        }
    ...
    /*
     *  callback if login to humana success using social access_token
     */
    ...
    /**
     * callback if login to humana failed using social access_token
     */
