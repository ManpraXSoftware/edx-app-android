...
import org.humana.mobile.interfaces.WebViewStatusListener;
...
import org.humana.mobile.view.custom.EdxWebView;
...
public abstract class BaseWebViewDiscoverFragment extends OfflineSupportBaseFragment
    ...
    /**
     * See description of: {@link org.humana.mobile.view.custom.URLInterceptorWebViewClient.IPageStatusListener#onPageLoadProgressChanged(WebView, int)
