package org.humana.mobile.module.analytics;
...
public interface Analytics {
    ...
    interface Values {
        ...
        String VIDEO_LOADED = "humana.video.loaded";
        String VIDEO_PLAYED = "humana.video.played";
        String VIDEO_PAUSED = "humana.video.paused";
        String VIDEO_STOPPED = "humana.video.stopped";
        //The seek event name has been changed as per MOB-1273
        String VIDEO_SEEKED = "humana.video.position.changed";
        String TRANSCRIPT_SHOWN = "humana.video.transcript.shown";
        String TRANSCRIPT_HIDDEN = "humana.video.transcript.hidden";
        String TRANSCRIPT_LANGUAGE = "humana.bi.video.transcript.language.selected";
        String FULLSREEN_TOGGLED = "humana.bi.video.screen.fullscreen.toggled";
        String BROWSER_LAUNCHED = "humana.bi.app.browser.launched";
        String SINGLE_VIDEO_DOWNLOAD = "humana.bi.video.download.requested";
        String BULK_DOWNLOAD_SUBSECTION = "humana.bi.video.subsection.bulkdownload.requested";
        String VIDEO_DOWNLOADED = "humana.bi.video.downloaded";
        String USERLOGOUT = "humana.bi.app.user.logout";
        String USERLOGIN = "humana.bi.app.user.login";
        String APP_NAME = "humana.mobileapp.android";
        String DISCOVERY_COURSES_SEARCH = "humana.bi.app.discovery.courses_search";
        String USER_FIND_COURSES = "humana.bi.app.search.find_courses.clicked";
        String CREATE_ACCOUNT_CLICKED = "humana.bi.app.user.register.clicked";
        String USER_REGISTRATION_SUCCESS = "humana.bi.app.user.register.success";
        String USER_COURSE_ENROLL_CLICKED = "humana.bi.app.course.enroll.clicked";
        String USER_COURSE_ENROLL_SUCCESS = "humana.bi.app.course.enroll.success";
        String USER_NO_ACCOUNT = "humana.bi.app.user.signup.clicked";
        ...
        String CONNECTION_CELL = "humana.bi.app.connection.cell";
        String CONNECTION_SPEED = "humana.bi.app.connection.speed";

        String NOTIFICATION_RECEIVED = "humana.bi.app.notification.course.update.received";
        String NOTIFICATION_TAPPED = "humana.bi.app.notification.course.update.tapped";

        String SOCIAL_CERTIFICATE_SHARED = "humana.bi.app.certificate.shared";
        String SOCIAL_COURSE_DETAIL_SHARED = "humana.bi.app.course.shared";
        ...
        String PROFILE_VIEWED = "humana.bi.app.profile.view";
        String PROFILE_PHOTO_SET = "humana.bi.app.profile.setphoto";
        String COMPONENT_VIEWED = "humana.bi.app.navigation.component.viewed";
        String OPEN_IN_BROWSER = "humana.bi.app.navigation.open-in-browser";
        ...
        String APP_REVIEWS_VIEW_RATING = "humana.bi.app.app_reviews.view_rating";
        String APP_REVIEWS_DISMISS_RATING = "humana.bi.app.app_reviews.dismiss_rating";
        String APP_REVIEWS_SUBMIT_RATING = "humana.bi.app.app_reviews.submit_rating";
        String APP_REVIEWS_SEND_FEEDBACK = "humana.bi.app.app_reviews.send_feedback";
        String APP_REVIEWS_MAYBE_LATER = "humana.bi.app.app_reviews.maybe_later";
        String APP_REVIEWS_RATE_THE_APP = "humana.bi.app.app_reviews.rate_the_app";
        // WhatsNew event values
        String WHATS_NEW_CATEGORY = "whats-new";
        String WHATS_NEW_CLOSE = "humana.bi.app.whats_new.close";
        String WHATS_NEW_DONE = "humana.bi.app.whats_new.done";
        // Course Videos event values
        String VIDEOS_SUBSECTION_DELETE = "humana.bi.app.video.delete.subsection";
        String VIDEOS_UNDO_SUBSECTION_DELETE = "humana.bi.app.video.undo.subsection.delete";
        String VIDEOS_UNIT_DELETE = "humana.bi.app.video.delete.unit";
        String VIDEOS_UNDO_UNIT_DELETE = "humana.bi.app.video.undo.unit.delete";
        // Bulk download feature event values
        String BULK_DOWNLOAD_SWITCH_ON = "humana.bi.app.videos.download.toggle.on";
        String BULK_DOWNLOAD_SWITCH_OFF = "humana.bi.app.videos.download.toggle.off";
        ...
        // Subjects
        String SUBJECT_CLICKED = "humana.bi.app.discover.subject.clicked";
