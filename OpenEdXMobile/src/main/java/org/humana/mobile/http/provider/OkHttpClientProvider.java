package org.humana.mobile.http.provider;
...
import org.humana.mobile.http.interceptor.CustomCacheQueryInterceptor;
import org.humana.mobile.http.interceptor.JsonMergePatchInterceptor;
import org.humana.mobile.http.interceptor.NewVersionBroadcastInterceptor;
import org.humana.mobile.http.interceptor.NoCacheHeaderStrippingInterceptor;
import org.humana.mobile.http.interceptor.OauthHeaderRequestInterceptor;
import org.humana.mobile.http.authenticator.OauthRefreshTokenAuthenticator;
import org.humana.mobile.http.interceptor.StaleIfErrorHandlingInterceptor;
