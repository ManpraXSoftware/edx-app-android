package org.humana.mobile.tta.ui.base;
...
import org.humana.mobile.tta.widget.loading.ILoading;
import org.humana.mobile.tta.widget.loading.ProgressDialogLoading;
import org.humana.mobile.util.PermissionsUtil;
import org.humana.mobile.view.dialog.AlertDialogFragment;
...
public class TaBaseActivity extends RxAppCompatActivity implements RoboContext, ILoading {
    ...
    public void showIndefiniteSnack(String msg, String actionText, View.OnClickListener listener){
    ...
    public void showIndefiniteSnack(String msg){
        showIndefiniteSnack(msg, getString(android.R.string.ok), null);
    }
