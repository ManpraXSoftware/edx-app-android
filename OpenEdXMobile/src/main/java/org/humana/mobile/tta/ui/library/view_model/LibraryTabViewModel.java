...
import org.humana.mobile.databinding.TRowContentBinding;
import org.humana.mobile.databinding.TRowContentListBinding;
import org.humana.mobile.databinding.TRowContentSliderBinding;
...
import org.humana.mobile.tta.data.enums.ContentListType;
    ...
    public void showContentDashboard(){
        ...
        if (selectedContent.getSource().getType().equalsIgnoreCase(SourceType.course.name()) ||
            ...
            mActivity.analytic.addMxAnalytics_db(
                    ...
                    org.humana.mobile.tta.analytics.analytics_enums.Source.Mobile, selectedContent.getSource_identity());
