...
package com.ankit.mxrangepicker.date;
...
import com.ankit.mxrangepicker.HapticFeedbackController;
import com.ankit.mxrangepicker.R;
import com.ankit.mxrangepicker.TypefaceHelper;
import com.ankit.mxrangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
        ...
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, isStart);
        return ret;
    }
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               ...
                                               boolean isStart) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, yearEnd, montOfYearEnd, dayOfMonthEnd, isStart);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, boolean isStart) {
        initialize(callBack, year, monthOfYear, dayOfMonth, year, monthOfYear, dayOfMonth, isStart);
        if (isStart) {
            tabPosition = 0;
        } else {
            tabPosition = 1;
